...
@SUITE.add("benchmarking")
def turn_easy(time_limit=_DEFAULT_TIME_LIMIT,xml_file_id=None, random=None, environment_kwargs=None):
...
@SUITE.add("benchmarking")
def turn_hard(time_limit=_DEFAULT_TIME_LIMIT,xml_file_id=None, random=None, environment_kwargs=None):
