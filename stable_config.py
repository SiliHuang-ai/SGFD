...
parser = argparse.ArgumentParser(description='sample reweighting')
...
parser.add_argument ('--num_f', type=int, default=5, help = 'number of fourier spaces')#1
...
parser.add_argument ('--lambdap', type = float, default = 0.01, help = 'weight decay for weight1 ')
...
parser.add_argument('--sum', type=bool, default=False, help='sum or concat')
